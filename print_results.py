...
#      print("\n\n*** Results Summary for CNN Model Architecture",model.upper(), 
#           "***")
#     print(model, "is used as the MODEL")
#     print(results_stats_dic['n_images'],"Are the number of images")
#     print(results_stats_dic['n_dogs_img'],"Are the number of dog images")
#     print(results_stats_dic['n_notdogs_img'],"Are the number of not-a-dog images")
    
#     # incorrectly classified dog  if requested
...
#             is_match = results_dic[filename][2]
#             if is_dog != is_match:
#                 print("Pet Label: {}, Classifier Label: {}".format(pet_label, classifier_label))

#     # incorrectly classified dog breeds if requested
